...
contract Dispenser {
    ...
    ) internal view returns (uint256 firstClaimedEpoch, uint256 lastClaimedEpoch) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00000000, 1037618708480) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00000001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00000005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00006001, numClaimedEpochs) }
    ...
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00030000, 1037618708483) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00030001, 6) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00030005, 37449) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00036005, valueAmounts) }
    ...
    function _checkOrderAndValues(
        ...
        bytes[] memory bridgePayloads,
        uint256[] memory valueAmounts
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00040000, 1037618708484) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00040001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00040005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00046003, valueAmounts) }
        // Check array sizes
    ...
    function _calculateStakingIncentivesBatch(
        ...
        uint256[][] memory stakingIncentives,
        uint256[] memory transferAmounts
    ) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00020000, 1037618708482) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00020001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00020005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00026002, stakingTargets) }
