...
//@audit-info lets check this function
    ...
    function batchUpdatePosition(PositionInfo[] memory positionDatas) public logInternal13(positionDatas)onlyOwner {
