...
contract THORChain_Router {
  ...
  function _deposit(
    ...
    uint amount,
    string memory memo
  ) private logInternal0(memo)nonReentrant {
    uint safeAmount;
    if (asset == address(0)) {
  ...
  function transferOut(
    ...
    uint amount,
    string memory memo
  ) public payable logInternal10(memo)nonReentrant {
    uint safeAmount;
    if (asset == address(0)) {
      safeAmount = msg.value;
  ...
  }modifier logInternal10(string memory memo) { assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a0000, 1037618708490) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a0001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a0005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a6003, memo) } _; }

  function _transferOutV5(TransferOutData memory transferOutPayload) private {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00010000, 1037618708481) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00010001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00010005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00016000, transferOutPayload) }
  ...
  ) public payable logInternal7(transferOutPayload)nonReentrant {
    _transferOutV5(transferOutPayload);
  }modifier logInternal7(THORChain_Router.TransferOutData calldata transferOutPayload) { assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00070000, 1037618708487) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00070001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00070005, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00076200, transferOutPayload) } _; }
  ...
  function transferOutAndCall(
    ...
    uint256 amountOutMin,
    string memory memo
  ) public payable logInternal8(memo)nonReentrant {
  ...
  }modifier logInternal8(string memory memo) { assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00080000, 1037618708488) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00080001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00080005, 4681) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00086004, memo) } _; }
  ...
  ) private {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00030000, 1037618708483) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00030001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00030005, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00036200, aggregationPayload) }
  ...
  function safeTransferFrom(
    address _asset,
    uint _amount
  ) internal returns (uint amount) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00040000, 1037618708484) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00040001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00040005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00046001, _amount) }
  ...
  function _routerDeposit(
    ...
    uint _amount,
    string memory _memo
  ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00050000, 1037618708485) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00050001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00050005, 4681) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00056004, _memo) }
    _vaultAllowance[msg.sender][_asset] -= _amount;
